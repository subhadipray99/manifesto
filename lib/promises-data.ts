...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    bengali: "কৃষি ও গ্রামীণ অর্থনীতি",
  ...
  },
  {
    ...
    bengali: "মৎস্যচাষ ও ব্লু ইকোনমি",
  ...
  },
  {
    ...
    bengali: "অন্তর্ভুক্তিমূলক উন্নয়ন",
  ...
  },
  {
    ...
    promises: [
      ...
      },
      {
        ...
        detail:
          "Resolve land issues to fast-track 61 stalled railway projects in the state.",
      },
      {
        id: "inf-6",
  ...
  },
  {
    ...
    promises: [
      ...
      {
        id: "t-2",
        title: "Sustainable Sundarban tourism",
        detail:
          "Develop Sundarbans as a sustainable, eco-friendly tourism destination with new livelihood opportunities.",
      },
      {
        id: "t-3",
        title: "Blue Flag for Digha & Mandarmoni",
        detail: "Modernise Digha, Mandarmoni and other coastal areas and pursue Blue Flag certification.",
      },
      {
        id: "t-4",
        title: "International tea tourism in Dooars",
        detail: "Workshops, festivals and tea-bungalow stays to position Bengal as a global tea tourism hub.",
      },
      {
        id: "t-5",
        title: "UNESCO World Heritage Living City — Kolkata",
        detail: "Pursue UNESCO 'World Heritage Living City' status for Kolkata with riverfront and ghat restoration.",
      },
      {
        id: "t-6",
        title: "Royal Bengal Tiger conservation",
        detail: "Relentless work on Royal Bengal Tiger conservation and habitat protection.",
      },
      {
        id: "t-7",
        title: "Mangrove restoration under MISHTI",
        detail: "Conserve and restore West Bengal's mangroves under the MISHTI scheme.",
      },
    ],
  },
]
...
export const STATUS_META: Record<
  PromiseStatus,
  { label: string; dot: string; chip: string; ring: string; emoji: string }
> = {
  pending: {
    label: "Not Started",
...
export const STATUS_ORDER: PromiseStatus[] = ["pending", "in-progress", "fulfilled", "broken"]

export function totalPromises() {
  return CATEGORIES.reduce((acc, c) => acc + c.promises.length, 0)
}
